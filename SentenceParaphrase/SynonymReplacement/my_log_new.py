...
class Logger:
    ...
    """
    handler_D = logging.handlers.TimedRotatingFileHandler(config_SR.info_file, when='H', interval=3, backupCount=30,
    ...
    handler_E = logging.handlers.TimedRotatingFileHandler(config_SR.err_file, when='H', interval=3, backupCount=30,
                                                        delay=False, utc=False)
    # 设置日志文件后缀，以当前时间作为日志文件后缀名。
